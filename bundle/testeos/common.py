...
type_RR = ["ADD","ADC","SUB","AND","OR" ,"XOR","CMP","MOV", "CMB"]
type_RM = ["STR","LOAD"]
type_M  = ["JZ","JN"]
type_R  = ["JC","JMP","INC","DEC","NEG", "SIG"]
type_RS = ["SHR","SHL"]
type_RI = ["SET"]
def_DB  = ["DB"]

opcodes = {"ADD" : 1, "ADC" : 2, "SUB" : 3, "AND"  : 4, "OR"  : 5, "XOR" : 6, "CMP" : 7, "MOV" : 8, "SIG" : 9, 
	   "NEG" :10, "CMB" : 11, "STR" :16, "LOAD":17, "STRr":18, "LOADr":19,
           "JMP" :20, "JC"  :21, "JZ"  :22, "JN"   :23, "INC" :24, "DEC" :25, "SHR" :26, "SHL"  :27, "SET" :31}
