...
CANT_PARAMS = 8
LINEAS = ["clk", "req", "rw", "ack", "d0", "d1", "d2", "d3"]
...
if (len(sys.argv)==1):
    print "Corriendo en modo visualización"
    print "Para correr todo junto ejecutar:"
    print "python visual.py a a a a v v v v"
    print "   donde a a a a es la dirección y v v v v es el dato"
    launchProcess = False
    ...
    print " - Con", CANT_PARAMS ,"parámetros booleanos, para lanzar todos los procesos y al cliente con la dirección pasada como parámetro"
    sys.exit()
