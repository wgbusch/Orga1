...
if (len(sys.argv)==1):
    ...
    print " - Con", CANT_PARAMS ,"parámetros booleanos, para lanzar todos los procesos"
    sys.exit()
...
if(launchProcess):
    ...
    #time.sleep(1)
    clien = subprocess.Popen('./KITT', stdin=PIPE, stdout=devnull)
